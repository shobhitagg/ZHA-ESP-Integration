...
DEBUG_COMP_ZHA = "custom_components.zha_custom"
DEBUG_LIB_ZHA = "zha"
...
DEBUG_COMP_ZIGPY_ZNSP = "zigpy_espzb"
...
DEBUG_LEVELS = {
    ...
    DEBUG_COMP_ZIGPY_ZNSP: logging.DEBUG,
...
def async_capture_log_levels() -> dict[str, int]:
    ...
    return {
        ...
        DEBUG_COMP_ZIGPY_ZNSP: logging.getLogger(
            DEBUG_COMP_ZIGPY_ZNSP
        ).getEffectiveLevel(),
...
def async_set_logger_levels(levels: dict[str, int]) -> None:
    ...
    logging.getLogger(DEBUG_COMP_ZIGPY_ZNSP).setLevel(levels[DEBUG_COMP_ZIGPY_ZNSP])
